...
public class ViewPackage extends JFrame implements ActionListener{
    ...
    {
        setBounds(300,160,900,500);
        getContentPane().setBackground(Color.WHITE);
        setLayout(null);
        
        JLabel l = new JLabel("VIEW PACKAGE DETAILS");
         l.setBounds(60, 0, 300, 30);
         ...
         l1 = new JLabel("Username");
          ...
          try{
                ...
                while(rs.next())
                {
                    ...
                    l8.setText(rs.getString("package"));
                    l10.setText(rs.getString("price"));
                    l12.setText(rs.getString("phone"));
                    l14.setText(rs.getString("persons"));
